  ...
  return (
    <div className='question-container'>
      <div className='questions'>
        <h2 className='question-title'>Q-1: How does React works?</h2>
      ...
      <div className='questions'>
        <h2 className='question-title'>Q-2: What is the difference between props and state?</h2>
      ...
      <div className='questions'>
        <h2 className='question-title'>Q-3: What is the use of useEffect other than fetching data?</h2>
